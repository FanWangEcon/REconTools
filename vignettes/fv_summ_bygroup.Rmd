...
Show percentiles, mean, sd, min, max, first, last, and unique counts across quantitative variables in a dataset. This file works out how the [ff_summ_bygroup](https://fanwangecon.github.io/REconTools/reference/ff_summ_bygroup.html) function works from [Fan](https://fanwangecon.github.io/)'s *[REconTools](https://fanwangecon.github.io/REconTools/)* Package.
