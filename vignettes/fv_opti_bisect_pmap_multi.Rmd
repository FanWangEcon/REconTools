---
title: Solve Roots for N (Rows) Strictly Monotonic Functions
description: |
  Solve for roots for the same function across N sets of parameter values.
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Solve Roots for N (Rows) Strictly Monotonic Functions}
